...
Defines the requirements for the Breeze-ASR-25 ASR engine implementation. This engine leverages faster-whisper (CTranslate2) or HuggingFace Transformers to perform Taiwanese Mandarin speech recognition with code-switching support.
