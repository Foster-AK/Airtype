# Spec: ASR Qwen3 OpenVINO Engine

## Purpose

Provides the Qwen3-ASR INT8 quantized OpenVINO inference engine for offline, CPU-first speech recognition on Windows, macOS, and Linux. This engine integrates with the ASR abstraction layer and numpy-preprocessor to deliver accurate Mandarin and multilingual recognition without GPU requirements.
