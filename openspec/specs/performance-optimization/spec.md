...
Defines performance benchmarks, resource usage targets, lazy loading behaviour, and the tooling used to measure and track performance regressions for the Airtype desktop application.
