# Spec: settings-appearance

## Overview

Appearance settings page within the Settings Panel. Provides theme selection, capsule position and scale, opacity, waveform style and colour, and overlay display controls. Changes are applied immediately and auto-saved.
